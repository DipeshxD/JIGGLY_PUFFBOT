...
print("")
print("""Welcome To D3VILBot String Session\nGenerator By @D3krish\n\n""")
print("""Special Thanks To My Buddy Respective savageBot\nOwner \n\n""")
...
while True:
    try:
        with TelegramClient(StringSession(), API_KEY, API_HASH) as client:
            ...
            client.send_message(
                "me",
                f"Here is your TELEGRAM STRING SESSION\n(Tap to copy it)👇 \n\n `{session}` \n\n And Visit @D3VIL_BOT_SUPPORT For Any Help!\n\n",
            )
